...
3.2. Репликация и резервное копирование применяются  для повышения надежности системы, но, дополняя друг друга, решают разные задачи и дают преимущество в различных сценариях.
